        ...
        __createDom: function () {
            ...
            if (this.setting.hasHiddenInput) {
                if (typeof this.setting.hasHiddenInput == 'string') {
                    this.hiddenInput = $('<input type="hidden" name="' + this.setting.hasHiddenInput + '" id="vcode_hidden_input_'+this.uid +'">');
                ...
                if(this.baseElement.get(0) == document.body){
                    this.baseElement.append(this.hiddenInput)
                }else{
                    this.baseElement.after(this.hiddenInput);
                }
            }
